    ...
    <div className="min-h-screen pb-24" style={{ background: 'var(--bg)' }}>
      <div className="max-w-lg mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <QuickLogButton icon={<svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--feed-red)" strokeWidth="1.4" strokeLinecap="round"><path d="M6 6h12v14a2 2 0 01-2 2H8a2 2 0 01-2-2V6z"/><path d="M8 2h8v4H8z"/><path d="M6 12h12"/></svg>} label={logAction === 'feed' ? 'Logged!' : 'Feed'} colour="var(--feed-red)" onClick={() => handleQuickLog('feed')} />
